...
function replace_core_jquery() {
	...
	if($dukeyin_options['jquery-cdn'] === 'on'){
		...
		wp_register_script( 'jquery-core', "//cdn.bootcdn.net/ajax/libs/jquery/3.6.0/jquery.min.js", array(), '3.6.0' );
		wp_deregister_script( 'jquery-migrate' );
		wp_register_script( 'jquery-migrate', "//cdn.bootcdn.net/ajax/libs/jquery-migrate/3.3.2/jquery-migrate.min.js", array(), '3.3.2' );
	}
}
