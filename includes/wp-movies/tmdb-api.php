...
// require (MOVIES__PLUGIN_DIR ."configuration/all.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/ApiBaseObject.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Collection.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Company.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Episode.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Genre.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Movie.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Person.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Role.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/Season.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/data/TVShow.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/roles/MovieRole.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/roles/TVShowRole.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/config/APIConfiguration.php");
require (MOVIES__PLUGIN_DIR ."controller/classes/config/Configuration.php");
