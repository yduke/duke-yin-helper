 ...
 * @subpackage Duke_Yin_Helper/admin
 */
...
class Duke_Yin_Helper_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/duke-yin-helper-admin.css', array(), $this->version, 'all' );
